...
export const translations: Record<Language, Record<string, string>> = {
  he: {
    ...
    'dashboard.generate_insights_button': 'צור תובנות AI',
    'dashboard.geocode_report_button': 'טיוב כתובות',
  ...
  en: {
    ...
    'dashboard.generate_insights_button': 'Generate AI insights',
    'dashboard.geocode_report_button': 'Address Verification',
  ...
  es: {
    ...
    'dashboard.generate_insights_button': 'Generar insights de IA',
    'dashboard.geocode_report_button': 'Verificación de Dirección',
